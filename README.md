...
7. Validates Foundry prerequisites, confirms the configured `FOUNDRY_MODEL_DEPLOYMENT_NAME` exists in the target `FOUNDRY_PROJECT_ENDPOINT`, runs a smoke test, and then deploys a prompt agent version using the assets under [foundry/](foundry/).
